...
1. **Manca una privacy policy** collegata all'app (né in-app né nella scheda Play Store attesa). Serve: scrivere/generare una privacy policy che copra AdMob, Facebook Login e Firebase, pubblicarla su un URL raggiungibile, e linkarla sia nella scheda Play Store sia da qualche parte in-app (es. Impostazioni).
