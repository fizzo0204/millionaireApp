...
1. **La privacy policy è scritta e pubblicata, ma non ancora linkata da nessuna parte**: vive su Firebase Hosting (`public-site/privacy-policy.html`) all'URL `https://millionaire-app-69005.web.app/privacy-policy.html`. Resta da: (a) inserirla nella scheda Play Store quando la crei, e (b) aggiungere un link ad essa in-app, tipicamente in Impostazioni — quest'ultimo è un piccolo task di codice, non ancora fatto.
